...
def yolo_model(weights = None, model_save_path = None):
    yolov3 = None
    if weights:
        yolov3 = make_yolov3_model()

        # get from https://pjreddie.com/darknet/yolo/
...
def prediction(model, img, image_w = 416, image_h = 416, custom_labels=None,threshold = None):
    ...
    do_nms(boxes, 0.5)
    return yhat, get_boxes(boxes, labels, class_threshold)